...
class PlaceDetailPhotoAdapter(private val photoList: ArrayList<ModelCasePhotoOnly>, private val mContext: Context) : RecyclerView.Adapter<PlaceDetailPhotoAdapter.CustomViewHolder>() {
