...
//    var placeDataList = arrayListOf<ModelPlaceMainCard>() //TourApi에서 가져온 장소정보
    var placeDataList = arrayListOf<ModelPlaceMainCard>() // FirebaseDB에서 가져온 장소 정보
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnPlaceSearch.setOnClickListener {
            ...
            mAdapter = PostWritePlaceSearchAdapter(placeDataList, this, postWritePlaceSearchLauncher)
            binding.rvPlaceSearch.adapter = mAdapter
            getPlaceData(keyword)
    ...
    // Firebase 데이터 가져오기
    private fun getPlaceData(keyword: String) {
        Log.d("로그---placeMainFrag", "getPlaceData start $keyword")
                                        ...
                                        for (document2 in documents2) {
                                            ...
                                            storageRef.child("place/$placePhoto").downloadUrl
                                                    .addOnSuccessListener { uri ->
                                                        ...
                                                        Log.d("로그--postWritePlaceSearch","placeDataList : ${placeDataList}")
