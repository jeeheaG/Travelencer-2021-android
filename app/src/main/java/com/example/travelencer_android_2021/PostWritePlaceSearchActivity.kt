...
class PostWritePlaceSearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val placeList = arrayListOf(
                ModelCasePlaceCard(imageUrl, "해우재", "경기도 수원시"),
                ModelCasePlaceCard(imageUrl, "수원 화성", "경기도 수원시"),
                ModelCasePlaceCard(imageUrl, "무슨산 공원", "경기도 수원시"),
                ModelCasePlaceCard(imageUrl, "수원 관광지", "경기도 수원시"),
                ModelCasePlaceCard(imageUrl, "뭐라고갈비", "경기도 수원시"),
                ModelCasePlaceCard(imageUrl, "광교산", "경기도 수원시"),
                ModelCasePlaceCard(imageUrl, "수원 왕갈비", "경기도 수원시"),
                ModelCasePlaceCard(imageUrl, "무슨호수", "경기도 수원시"),
                ModelCasePlaceCard(imageUrl, "저기호수공원", "경기도 수원시")
        )
