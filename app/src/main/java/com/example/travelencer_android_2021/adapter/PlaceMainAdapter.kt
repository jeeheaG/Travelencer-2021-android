...
class PlaceMainAdapter(val placeList: ArrayList<ModelPlaceMain>, val mContext: Context): RecyclerView.Adapter<PlaceMainAdapter.CustomViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlaceMainAdapter.CustomViewHolder {
        ...
        return CustomViewHolder(view).apply {
            itemView.setOnClickListener {
                ...
                val place: ModelPlaceMain = placeList[curPosition]
...
/*        fun clickListener(itemView: View){
            itemView.setOnClickListener{
                val intent = Intent(it.context, PlaceDetailActivity::class.java)
                intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK
                it.context.startActivity(intent)
